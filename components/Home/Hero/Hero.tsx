...
const Hero = () => {
  return (
    <div className="relative w-full h-[120vh] sm:[100vh]">
      {/* overlay */}
            ...
            <div>
              ...
              <h1 className="text-[25px] mb-4 md:mb-0 text-center md:text-[35px] lg:text-[45px] tracking-[0.7rem] text-white font-bold uppercase">Lets Enjoy The Nature
                ...
                <div className="text-center items-center flex flex-col">
                    ...
                    <span className="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease z-[1000]"></span>
